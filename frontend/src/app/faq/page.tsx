  ...
  const items = useMemo<FaqItem[]>(
    () => [
      ...
      },
      {
        ...
        a: "Если AI не смог сгенерировать качественные вопросы, система применяет безопасный fallback и помечает вопросы как needs_regen. Такой модуль не публикуется для партнёров до успешной регенерации.",
      },
      {
